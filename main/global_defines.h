...
#define MOTOR_BACK_LEFT 0 // rename to match where the motor is or its function
...
#define MOTOR_BACK_RIGHT 3 // rename to match where the motor is or its function
